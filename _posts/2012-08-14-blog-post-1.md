...
<img src="portfolio/images/fl_4x4_noslip.gif" alt="Gif Frozen Lake" width="325px" style="float: right; box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src="https://github.com/ghj95/portfolio/blob/69c9564d2f5e934c3a69dab5af40fff3aea7f4f4/images/fl_4x4_noslip.gif" alt="Results Frozen Lake No Slip" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Deterministic environment</figcaption>
</figure>

<figure style="float: left; margin: 0; padding: 0;">
  <img src="ghj95/portfolio/blob/master/images/fl_4x4_noslip.gif" alt="Results Gif Frozen Lake Slip" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src="https://github.com/ghj95/portfolio/blob/master/images/fl_4x4_noslip.gif" alt="Base Gif Frozen Lake" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Deterministic environment</figcaption>
</figure>
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src=".portfolio/images/lake_4x4_noslip.png" alt="Base Gif Frozen Lake" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Stochastic environment</figcaption>
</figure>

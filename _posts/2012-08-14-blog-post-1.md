...
<img src="/portfolio/images/blog/frozen_lake-1.gif" alt="Gif Frozen Lake" width="280px" style="float: right; box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
...
In contrast, in the stochastic slippery environment, the agent finds a very different strategy by favoring moving in the direction of the edges and betting for the $$1/3$$ probability of being pushed in the opposite direction in order to attain its goal. 

...
<img src="/images/fl_4x4_noslip.gif" alt="Gif Frozen Lake" width="325px" style="float: right; box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src="/images/lake_4x4_noslip.png" alt="Base Gif Frozen Lake" width="350px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Deterministic environment</figcaption>
</figure>

<figure style="float: left; margin: 0; padding: 0;">
  <img src="/images/lake_4x4_slip.png" alt="Base Gif Frozen Lake" width="350px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src="/images/fl_4x4_slip.gif" alt="Base Gif Frozen Lake" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Deterministic environment</figcaption>
</figure>
...
<figure style="float: left; margin: 0; padding: 0;">
  <img src="/images/fl_4x4_noslip.gif" alt="Base Gif Frozen Lake" width="200px" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
  <figcaption style="text-align: left; font-style: italic; font-size: 0.9em; margin-top: 5px;">Stochastic environment</figcaption>
</figure>
